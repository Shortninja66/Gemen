...
/**
 * Class for creating a sign GUI for user input
 * 
 * @since 14 March 2016 6:48 AM
 * @author nisovin, Shortninja
 */
...
public class SignGUI {
	...
	class PacketListener extends PacketAdapter {
		...
		public void onPacketReceiving(PacketEvent event) {
			...
			if(list.get(0) != v.getBlockX())
				return;
			if(list.get(1) != v.getBlockY())
				return;
			if(list.get(2) != v.getBlockZ())
				return;
