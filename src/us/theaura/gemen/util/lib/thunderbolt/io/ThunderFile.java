package us.theaura.gemen.util.lib.thunderbolt.io;
...
import us.theaura.gemen.util.lib.thunderbolt.org.json.JSONArray;
import us.theaura.gemen.util.lib.thunderbolt.org.json.JSONObject;
import us.theaura.gemen.util.lib.thunderbolt.utils.Validator;

/**
 * File class containing numerous useful methods for setting, saving, and
 * retrieving information from JSON files
 * 
...
public class ThunderFile {
	 ...
	 * @see ThunderFile
	 * @param name
	 *            : The name of the file, excluding the .json extension.
	 * @param path
	 ...
	 * 
	 * @param key
	 *            : The key associated with this String
	 ...
	 * 
	 * @param key
	 *            : The key associated with this Byte
	 ...
	 * 
	 * @param key
	 *            : The key associated with this Short
	 ...
	 * 
	 * @param key
	 *            : The key associated with this Integer
	 ...
	 * 
	 * @param key
	 *            : The key associated with this Double
	 ...
	 * 
	 * @param key
	 *            : The key associated with this Long
	 ...
	 * 
	 * @param key
	 *            : The key associated with this Float
	 ...
	 * 
	 * @param key
	 *            : The key associated with this Boolean
	 ...
	 * 
	 * @param key
	 *            : The key associated with this list
	 * @return String List
	 */
	 ...
	 * 
	 * @param key
	 *            The key associated with the Map
	 * @return A Map
	 * @throws IllegalArgumentException
	 *             Value is not a Map
	 */
